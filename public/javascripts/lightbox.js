var Lightbox = {
	...
	showBoxByID:function(id,width,height) {
		...
		this.id = id; // for bugfix (see hideBox)
        this.showBox(width,height);
		return false;
	},
	...
	hideBox:function() {
        ...
        // fix begin .. see http://code.google.com/p/rb-lightbox-plugin/issues/detail?id=1
        if( this.id)
          while (contents.hasChildNodes()) $(this.id).appendChild(contents.firstChild);
        // fix end
